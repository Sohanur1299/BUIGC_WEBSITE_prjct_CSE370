...
if (isset($_GET['student_id'])) {
    ...
    $query_desig = "SELECT designation FROM member WHERE student_id = $id_is";
    ...
    if ($index_curr_desig > $lowest_rank) {
        ...
        $new_query_desig = "UPDATE member SET designation = '$new_desig' WHERE student_id = $id_is";
        ...
        // 
        $_SESSION['status'] = '[ ID: '.$id_is.' ]  Action: Lowest rank reached.';
        // 
        header('location:memberx_data.php');
        exit;
    }
